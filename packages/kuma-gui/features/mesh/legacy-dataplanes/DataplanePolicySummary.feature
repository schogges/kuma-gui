                  ...
                  default:
                    backendRefs:
                      - kind: MeshService
                        ...
                        weight: 1
      """
    When I visit the "/meshes/default/data-planes/dataplane-1/policies/meshhttproutes/kri_mhttpr_default_port_kuma-system_the-other-http-route_" URL
      ...
      body:
        ...
        spec:
          targetRef:
            ...
            name: foo
      """
    When I visit the "/meshes/default/data-planes/dataplane-1/policies/meshhttproutes/kri_mhttpr_default_port_kuma-system_<PolicyName>_" URL
